<%-- 
    Document   : books
    Created on : Sep 10, 2020, 12:19:38 PM
    Author     : Ukdmp Kasun
--%>
...
<body>
		...
		<div class="container">
			<div class="row justify-content-between align-items-center text-center banner-content">
				<div class="col-lg-12">
					...
					<p>List of Books with its' Title, Publisher, Author and Category</p>
				</div>
			</div>
		</div>
	</section>
	...
	<section class="top-category-widget-area section-gap">
		<div class="container">
		<center>	<h2 class="modal-title">Novels</h2></center>
			<div class="row">
                                            <%
try{ 
connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/library","root","");
statement=connection.createStatement();
String sql ="select * from books where category = 'Novel' ";
...
%> 
				...
				<div class="col-lg-3">
					<div class="card" style="width: 15rem;">
						<img class="img-fluid img-thumbnail" src="getImage.jsp?id=<%=id%>"  style="height: 130px; width: auto" alt="cover">
						<div class="card-body">
						<center>	<h5 class="card-title"><%=resultSet.getString(2)%></h5></center>
							<h6 style="color:black;"><b style="color:dimgrey;">Author: </b><%=resultSet.getString(3)%></h6>
							<h6 style="color:black;"><b style="color:dimgrey;">Publisher: </b><%=resultSet.getString(4)%></h6>
							<h6 style="color:black;"><b style="color:dimgrey;">Category: </b><%=resultSet.getString(5)%></h6>
...
%>
                ...
                <br>
                <center>	<h2 class="modal-title">Other Categories</h2></center>
			<div class="row">
                                            <%
try{ 
connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/library","root","");
