<%-- 
    Document   : magazines
    Created on : Sep 10, 2020, 12:31:44 PM
    Author     : Ukdmp Kasun
--%>
	...
	<section class="banner-area relative">
		...
		<div class="container">
			<div class="row justify-content-between align-items-center text-center banner-content">
				<div class="col-lg-12">
					<h1 class="text-white">Magazines</h1>
					<p>List of Magazines with Details</p>
				</div>
			</div>
		</div>
	</section>
...
%> 
				<div class="col-lg-3">
					<div class="card" style="width: 15rem;">
						<img class="img-fluid img-thumbnail" src="./img/t.jpg"  style="height: 130px; width: auto" alt="cover">
						<div class="card-body">
						<center>	<h5 class="card-title"><%=resultSet.getString(2)%></h5></center>
							<h6 style="color:black;"><b style="color:dimgrey;">Magazine Number: </b>Number</h6>
							<h6 style="color:black;"><b style="color:dimgrey;">Publisher: </b><%=resultSet.getString(3)%></h6>
                                                        <h6 style="color:black;"><b style="color:dimgrey;">Date: </b><%=resultSet.getString(4)%></h6>
						</div>
